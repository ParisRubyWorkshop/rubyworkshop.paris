...
const CodeOfConduct = (props) => (
  <Layout>
    <div className={s.codeOfConduct}>
      ...
      <p>
        Le but premier du Paris Ruby Workshop est d'accueillir <b>tou.te.s</b> les nouveaux.elles venu.e.s dans la communauté ruby parisienne, et de permettre à tou.te.s d'échanger sur des sujets techniques et humains autour du Ruby et du logiciel en général.
      </p>
  <p>
  ...
  <p>
    ...
    Ce code de conduite est inspiré du Code of Conduct de la <Link to="http://2012.jsconf.us/#/about">JS conf 2012</Link>. Si vous pensez qu'il peut être amélioré, nous serons ravi.e.s d'en discuter à l'oral, sur slack ou via une pull request.
  </p>
  <p>
  ...
  <p>
  Si un.e participant.e a un comportement de harcèlement, les organisateurs du workshop peuvent prendre toute action qui leur semble adéquate. Cela va d'un simple avertissement à l'exclusion du participant du workshop.
  </p>
  <p>
  Si vous vous sentez harcelé.e, si vous pensez que quelqu'un se fait harceler, et plus généralement en cas de problème, merci de contacter immédiatement un membre de l'organisation du workshop
  </p>

<h4>En cas de problème</h4>
Si vous rencontrez un problème, parlez-en sans hésiter à l'équipe d'organisation.
  <br/>
  ...
  <h4>Vous êtes dans l'équipe d'organisation et on vous remonte un problème</h4>
...
export default withStyles(s)(CodeOfConduct);
